...
CONTAINER="cr.loongnix.cn/apache/trino:${TRINO_VERSION}"

docker build ${WORK_DIR} -f Dockerfile -t ${CONTAINER} --build-arg "TRINO_VERSION=${TRINO_VERSION}"
...
test_container ${CONTAINER} linux/loongarch64
